...
1. Replace `<catalog>.<schema>` in the query with your catalog and schema (both
   occurrences), then paste it into the SQL editor and run to confirm it returns a row.
